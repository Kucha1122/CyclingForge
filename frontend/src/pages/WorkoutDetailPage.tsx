...
export const WorkoutDetailPage = () => {
  ...
  if (!workout) {
    return <div className="flex min-h-screen items-center justify-center"><p className="text-gray-500">Workout not found</p></div>;
  }
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-8 grid grid-cols-3 gap-4">
          <div className="rounded-xl bg-white p-4 text-center shadow-sm ring-1 ring-gray-200">
            <p className="text-2xl font-bold text-gray-900">{workout.durationMinutes} min</p>
            <p className="text-sm text-gray-500">Duration</p>
          </div>
          <div className="rounded-xl bg-white p-4 text-center shadow-sm ring-1 ring-gray-200">
            <p className="text-2xl font-bold text-gray-900">{workout.estimatedTSS}</p>
            <p className="text-sm text-gray-500">Estimated TSS</p>
          </div>
          <div className="rounded-xl bg-white p-4 text-center shadow-sm ring-1 ring-gray-200">
        ...
        {/* Interval Chart */}
        <div className="mb-8 rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
          <h2 className="mb-4 text-lg font-semibold text-gray-900">Workout Profile</h2>
              ...
              <tbody>
                {workout.steps.sort((a, b) => a.order - b.order).map(step => (
                  <tr key={step.id} className="border-b border-gray-50">
                    ...
                    <td className="py-2 pr-4 font-medium">{step.type}</td>
